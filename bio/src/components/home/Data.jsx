...
const Data = () => {
  return (
    <div className='home__data'>
        <h1 className='home__title'> Sourav Rai 
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className='home__description'>I'm a MERN developer based in Thimphu,Bhutan. I'm a very passionate and dedicated fullstack developer.</p>
